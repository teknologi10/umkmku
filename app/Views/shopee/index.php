...
<div class="content-wrapper">
    <section class="content mx-4">
        ...
        <a href="<?= base_url() ?>/shopee/tambah" class="btn btn-primary mb-2 mt-4">Tambah <?= $menu ?></a>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" action="<?= base_url(); ?>/shopee/simpanExcel" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    <?= csrf_field(); ?>
                                    <div class="card-body">
            ...
            <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <?php $no = 1;
                        foreach ($umum_shopee as $d) : ?>
                            <tr>
                                <!-- <td class="text-center"><?= $no++ ?></td> -->
                                <td><?= $d['tgl'] ?></td>
                                <td><?= $d['penjualan'] ?></td>
                                <td><?= $d['pesanan'] ?></td>
                                <td><?= $d['jual_perpesanan'] ?></td>
                                <td><?= $d['produk_dilihat'] ?></td>
                                <td><?= $d['total_pengunjung'] ?></td>
                                <td class="text-center">
                                    <!-- <a class="text-muted d-inline-block mr-2" href="<?= base_url(); ?>/user/edit_user/#<?= $d['id'] ?>">
                                        <i class="fas fa-edit"></i>
                                    </a> -->
                                    <a class="text-muted d-inline-block mr" href="<?= base_url(); ?>/shopee/hapus/<?= $d['id'] ?>" onclick="return confirm('apakah anda ingin hapus data?');">
